...
input_sender = st.text_area("Enter the sender info")
#st.checkbox(f" is the sender information: {input_sender} correct?")
# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
# YOUR CODE HERE
input_reciever  = st.text_area("Enter the reciever info")
#st.checkbox(f"is the reciever info: {input_reciever} correct?")
# @TODO:
# Add an input area where you can get a value for `amount` from the user.
# YOUR CODE HERE
input_amount = st.text_area("input the amount")  
